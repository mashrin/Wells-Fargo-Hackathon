...
def generate_data_transformation_config():
    ...
    column_group_1 = ['qrated_brand']
    
    column_group_2 = ['default_location']
    
    column_group_3 = [['merchant_cat_code'], ['amt']]
    
    column_group_4 = ['trans_desc', 'default_brand', 'qrated_brand', 'coalesced_brand']
    
    column_group_5 = [['merchant_cat_code']]
    ...
    feature_union = FeatureUnion([
        ...
        ('mapper_ed5fc4', get_mapper_ed5fc4(column_group_5)),
        ('mapper_d05ded', get_mapper_d05ded(column_group_2)),
        ('mapper_e30a49', get_mapper_e30a49(column_group_1)),
