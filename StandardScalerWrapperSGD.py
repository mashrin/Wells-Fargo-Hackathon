...
def generate_data_transformation_config():
    ...
    column_group_1 = ['sor', 'db_cr_cd', 'is_international']
    
    column_group_2 = [['trans_desc'], ['default_brand'], ['qrated_brand'], ['coalesced_brand']]
    
    column_group_3 = [['merchant_cat_code']]
    
    column_group_4 = [['merchant_cat_code'], ['amt']]
    
    column_group_5 = ['default_location']
    
    column_group_6 = ['trans_desc', 'default_brand', 'qrated_brand', 'coalesced_brand']
    
    column_group_7 = ['payment_category']
    
    column_group_8 = ['qrated_brand']
    
    feature_union = FeatureUnion([
        ('mapper_9133f9', get_mapper_9133f9(column_group_1)),
        ('mapper_49c852', get_mapper_49c852(column_group_7)),
        ('mapper_369e16', get_mapper_369e16(column_group_6)),
        ('mapper_2cf0a8', get_mapper_2cf0a8(column_group_6)),
        ('mapper_ab1045', get_mapper_ab1045(column_group_4)),
        ('mapper_ed5fc4', get_mapper_ed5fc4(column_group_3)),
        ('mapper_d05ded', get_mapper_d05ded(column_group_5)),
        ('mapper_e30a49', get_mapper_e30a49(column_group_8)),
        ('mapper_dbf06b', get_mapper_dbf06b(column_group_2)),
    ])
